...
namespace ForumApp.Controllers
{
    public class TopicsController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            await _context.Comment.ToListAsync();
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Description ,Forum_Id,Created_By")] Topic topic)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Forum_Id,Created_By")] Topic topic)
        {
            if (id != topic.Id)
            {
                return NotFound();
